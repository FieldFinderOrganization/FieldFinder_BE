...
public class RabbitMQConfig {
    ...
    public static final String BOOKING_REMINDER_EMAIL_QUEUE = "booking_reminder_email_queue";
    public static final String BOOKING_REMINDER_EMAIL_ROUTING_KEY = "booking_reminder_email_routing_key";
    ...
    public Queue reminderEmailQueue() {
        return new Queue(BOOKING_REMINDER_EMAIL_QUEUE, true);
    }

    @Bean
    public Binding reminderEmailBinding(Queue reminderEmailQueue, DirectExchange emailExchange) {
        return BindingBuilder.bind(reminderEmailQueue).to(emailExchange).with(BOOKING_REMINDER_EMAIL_ROUTING_KEY);
    }
